...
var Calendar = (function(window,$){
    ...
    Calendar.insertRecurringEvents = function(recurringEventOptions){
        ...
        for (var i = 0; i <= repeat; i++) { 
            ...
            var solarStart = cc.lunar2solar(new Date(parseInt(parsedOldDateStart['year']) + i, parseInt(parsedOldDateStart['month']) - 1, parsedOldDateStart['day']));
            ...
            var solarEnd = cc.lunar2solar(new Date(parseInt(parsedOldDateEnd['year']) + i, parseInt(parsedOldDateEnd['month']) - 1, parsedOldDateEnd['day']));
